...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '内容类目', icon: 'tree' }
      },
      {
        path: '/content/add',
        name: 'Form',
        component: () => import('@/views/content/add/index'),
        meta: { title: '添加内容', icon: 'form' }
      }
    ]
  },
    ...
    children: [
      {
        path: '/item/list',
        name: 'Table',
        component: () => import('@/views/item/list/index'),
        meta: { title: '商品列表', icon: 'table' }
      },
      {
        path: '/item/cat',
        name: 'Tree',
        component: () => import('@/views/item/cat/index'),
        meta: { title: '商品类目', icon: 'tree' }
      }
    ]
  },
